...
const config: Config = {
  ...
  headTags: [
    ...
    },
    {
      ...
      attributes: {
        ...
        content: 'Run AI models locally with complete privacy. OpenAI- & Ollama-compatible APIs, powered by Apple MLX.',
      },
    },
    {
      tagName: 'meta',
    ...
    },
    {
      ...
      attributes: {
        ...
        content: 'Run AI models locally with complete privacy and blazing performance.',
      },
    },
    {
      tagName: 'meta',
    ...
    },
    {
      ...
      innerHTML: JSON.stringify({
        ...
        author: { '@type': 'Organization', name: 'Osaurus', url: 'https://osaurus.ai' },
      }),
    },
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      { name: 'description', content: 'Osaurus — the fastest and most private AI runtime built specifically for Apple Silicon. Run AI models locally with complete privacy and blazing performance.' },
      { name: 'keywords', content: 'Osaurus, local AI, Apple Silicon, MLX, OpenAI API, Ollama, Swift, SwiftNIO, macOS, privacy' },
    ...
    navbar: {
      ...
      items: [
        ...
        { href: 'https://github.com/dinoki-ai/osaurus', label: 'GitHub', position: 'right' },
      ],
    },
    footer: {
      style: 'dark',
